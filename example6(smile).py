...
face_cascade = cv2.CascadeClassifier('28.10.2023\haarcascade_smile.xml')  # Haar Cascade XML dosyasını kullanabilirsiniz.
...
cv2.imwrite('28.10.2023/output_image_smile.jpg', input_image)
